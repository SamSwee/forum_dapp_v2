...
export default function Home() {
  const postManagerContract = "0x9FDcCf4DfB46E8aeeA54fa617ADae6361d5761Dd"; //postManager smart contract address
      ...
      <div className={styles.activePostContainer}>
        <div>
          <div style={{ paddingLeft: "40px" }}>
            <h1 className={styles.titleText}>{postData.postTitle} </h1>
          </div>
          ...
          <img
            ...
            width={400}
            height={'auto'}
            style={{ padding: "4px 4px 5px", borderColor: "#656EBB", border:"2px groove #656EBB", marginLeft:"50px"}}
          />
          <p className={styles.activePostText}>{postData.postContent} </p>
        </div>
        <div
          style={{
            padding: "5px",
    ...
    <>
      ...
      >
        <div className={styles.topPanel}>
          <div className={styles.walletAddress}>{`Forum dApp using web3.storage API`}</div>
